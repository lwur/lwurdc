...
module.exports = {
  ...
  run: async (client, message, args) => {
    if(!message.channel.name.includes("botsal")) return message.reply(`Bu Komutu Sadece ${message.guild.channels.cache.filter(x => x.name.includes("botsal")).map(x => x).join(", ")} kanallarında kullanabilirsiniz.`).then(x => {
        message.react(red)
